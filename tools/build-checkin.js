...
/* ============================================================
   ...
   Input: tools/checkin.template.html   (segnaposto {{HOUSE_KEY}}, {{HOUSE_NAME}}, {{HOUSE_PLACE}}, {{SLUG}})
...
const HOUSES = [
  { key: 'lido',   name: 'La Porta del Lido', place: 'Alghero',  slug: 'checkin-la-porta-del-lido' },
  { key: 'mimosa', name: 'Villa La Mimosa',   place: 'Stintino', slug: 'checkin-villa-la-mimosa' }
];
