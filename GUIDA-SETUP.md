...
**Versione mobile** (stessi cartoncini, ma con un pulsante al posto del QR — da mandare via WhatsApp agli ospiti, che sono già sul telefono). Una pagina per cartoncino, così si mandano in momenti diversi:

| | All'arrivo (registrazione) | Alla partenza (recensione) |
|---|---|---|
| La Porta del Lido | `leportedisardegna.com/registrazione-la-porta-del-lido` | `leportedisardegna.com/recensione-la-porta-del-lido` |
